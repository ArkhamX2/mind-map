        ...
        <main style={{ backgroundColor: "#FFFFFF", width: '100%', height: '100%', padding: "15px" }}>
            <div>
                <div className="searchcontainer" style={{ width: "100%", height: '100%', display: "flex", flexDirection: 'column' }}>
                    <div className="searchbarcontainer" style={{ display: 'inline-flex', justifyContent: 'space-between' }}>
                        ...
                        <div style={{display:'inline-flex'}}>
                            <div className="searchButton" style={{ width: '56px', height: '56px', backgroundColor: '#EBEBFF', marginRight:'10px', textAlign:'center', borderRadius:'10px' }}>Поиск</div>
                            <div className="filterbutton" style={{ width: '56px', height: '56px', backgroundColor: '#EBEBFF', borderRadius:'10px',  }}>Фильтр</div>
                        </div>

                    </div>
                    <div className="tagscontainer" style={{ display: 'flex', flexDirection: 'row' }}>
                    <div style={{
                ...
                <div className="cardContainer" style={{ display: 'grid', overflowY: 'auto', gridTemplateColumns: '1fr 1fr', columnGap: '10px' }}>
                    <AgrCard></AgrCard>
                    <AgrCard></AgrCard>
                    <AgrCard></AgrCard>
                    <AgrCard></AgrCard>
